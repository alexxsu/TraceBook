...
import { X, User as UserIcon, BarChart2, Layers, Info, Shield } from 'lucide-react';
            ...
            {isAdmin && onSiteManagement && (
              <>
                <div className="pt-3 mt-3 border-t border-gray-700">
                  <p className="text-xs text-purple-400 font-medium uppercase tracking-wider px-4 mb-2">Admin</p>
                </div>
                <button
                  onClick={() => {
                    onClose();
                ...
                >
                  ...
                  <div className="text-left">
                    <span className="font-medium block text-purple-300">Site Management</span>
                    <span className="text-xs text-purple-400/70">Manage users & settings</span>
                  </div>
                </button>
              </>
            )}
