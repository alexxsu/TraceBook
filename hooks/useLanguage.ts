...
const translations = {
  en: {
    ...
    tutorialMapManagementDesc: 'Here you can switch between maps, create new maps, or join other people\'s maps using a share code.',
  ...
  zh: {
    ...
    tutorialMapManagementDesc: '在这里你可以切换地图、创建新地图，或使用分享码加入他人的地图。',
